      ...
      <div>
        <div class="c_ticker2">
          <div class="container_page position-relative mx-auto">
            <div class="t1">
              <img src="_/images/t2.png" alt="">
            </div>
            <div class="t2">
              <img src="_/images/t6.png" alt="">
            </div>
            <div class="t3">
              <img src="_/images/t5.png" alt="">
            </div>
          </div>
  ...
  <div class="">
    <div class="padding_sections">
      <div class="bg-gray-light position-relative container_page px-0 mx-auto pb-lg-5">
        <div class="tit_h2 to_viewleft to_viewReset">
        ...
        <div class="c_videos_content">
          <div class="c_videos">
            <div class="v1 video">
              ...
              <div class="c_video">
              <iframe width="552" height="982" src="https://www.youtube.com/embed/poKxWOP3vnE" title="Porkcolombia" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
            <div class="v2 video">
              <div class="c_video">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/mX0oY4Ewcv0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
            <div class="v3 video">
              <div class="to_viewleft to_viewReset tit1">
                <h2 class="font-weight-bold font-italic mb-0">Contenido</h2>para redes sociales que llega donde tiene
                que llegar
              </div>
              <h6 class="to_viewleft to_viewReset">Comerciales</h6>
              <h6 class="to_viewleft to_viewReset">Casos de éxito</h6>
              <div class="c_video">
              <iframe width="552" height="982" src="https://www.youtube.com/embed/XC5BA7xAzQk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
            <div class="v4 video">
              ...
              <div class="c_video">
              <iframe width="552" height="982" src="https://www.youtube.com/embed/njM_Rs-DAMs" title="DEUNA I Checkout" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
            <div class="v5 video">
              <div class="c_video">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/ZiUZ5fkuVkY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
            <div class="v6 video">
              <div class="c_video">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/2kYFq7ciOd8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="padding_sections ">
    <div class="bg-gray-light mt_neg">
        ...
        <div class="c_gal_detalle mt-5">
          <div class="row no-gutters">
            <div class="col-md-6 px-2 to_view to_viewReset mb-3">
              <img src="_/images/grupocon1.jpg" alt="">
            </div>
            <div class="col-md-6 px-2 to_view to_viewReset mb-3">
              <img src="_/images/grupocon2.jpg" alt="">
            </div>
          </div>
        </div>
      ...
      <div class="container_page px-0 mt-lg-5 py-4 c_video_home  to_view to_viewReset">
        <div><iframe width="100%" height="720" src="https://www.youtube.com/embed/zs8YasF82Vs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
      </div>
        ...
        <div class="row pt-5 justify-content-center">
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/docs.jpg" alt="">
              <h5>DOCUMENTALES</h5>
              <p>Investigamos, escribimos, producimos y editamos documentales de la más alta calidad para marcas que quieren <strong>contar historias y despertar emociones.</strong> </p>
            </div>
          </div>
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/video.jpg" alt="">
              <h5>VIDEO COMERCIAL</h5>
              <p>Nos inventamos historias increíbles y llevamos las ideas de tu equipo hacia un producto que no solo <strong>emocione</strong> sino que <strong>cumpla los objetivos</strong> de tu marca.</strong> </p>
            </div>
          </div>
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/cubrimien.jpg" alt="">
              <h5>CUBRIMIENTOS</h5>
               <p>¿Quién dijo que un cubrimiento es aburrido? tenemos las mejores ideas para producir memorias audiovisuales fieles al <strong>espíritu de tu empresa.</strong></p>
            </div>
          </div>
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/producto.jpg" alt="">
          ...
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/institucion.jpg" alt="">
              <h5>INSTITUCIONAL</h5>

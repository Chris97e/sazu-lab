  ...
  <div class="position-relative">
    ...
    <div>
      <div class="c_ticker">
        ...
        <div class="marquee">
          <h1>INVESTIGACIÓN - MODELOS DE NEGOCIO - PROPUESTA DE VALOR - PILARES DE COMUNICACIÓN - AGILE COACHIING -</h1>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="rueda my-5 pt-4 pb-5">
          <div class="circle_estr">
            <div class=" to_view to_viewReset">
              <img src="_/images/circle_green.svg" alt="">
            </div>
          </div>
        ...
        <div class="row pt-lg-5 justify-content-center">
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/negocio.jpg" alt="">
          ...
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/comunica.jpg" alt="">
          ...
          <div class="col-lg- to_view to_viewReset">
            <div class="c_services_list">
              <img src="_/images/estmarca.jpg" alt="">

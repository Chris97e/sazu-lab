  ...
  <div class="position-relative">
    <div class="padding_sections">
      <div class="bg-gray-light pb-5">
        <!-- hero -->
        <div style="background: url(_/images/ccd.jpg);">
          <div class="row no-gutters hero_detalle align-items-center">
            ...
            <div class="col-lg-7 p-5">
              ...
              <h2 style="color: #5680DE;"><i>Visibilizar las iniciativas del programa Conectando Caminos por los Derechos de Pact. Para proteger los derechos de la población migrante venezolana y promover su integración e inclusión social en el territorio colombiano.  </i></h2>
            </div>
          </div>
        </div>
        ...
        <div class="py-lg-5 px-4">
          <div class="row justify-content-center info_basic py-lg-5 py-4">
            <div class="col-md-3 col-12 to_view to_viewReset">
              <img src="_/images/logopact.svg" alt="">
        ...
        <div class="py-5 ">
          ...
          <div class="row no-gutters justify-content-center resultsccd py-lg-5 py-4 px-md-0 px-4">
            <div class="col-md-5 px-md-4 to_view to_viewReset py-md-0 py-4">
              <h2 class="mb-2">$ 10.2 M</h2>
              <h5 class="mb-5">Gestionamos <strong
                  style="color:#5B4CFF;">“Free-press”</strong> en medios digitales por valores equivalentes a más de 10 millones de pesos si hubieran sido pagos.</h5>
            </div>
            <div class="col-md-5 px-md-4 to_view to_viewReset py-md-0 py-4">
              <h2 class="mb-2">8 talleres</h2>
              <h5 class="mb-5">Planeamos y lideramos con éxito más de 8 talleres de co-creación con socios estratégicos de la organización.</h5>
            </div>
            <div class="col-md-5 px-md-4 to_view to_viewReset py-md-0 py-4">
              <h2 class="mb-2">78,000</h2>
              <h5>Personas alcanzadas a través de <strong
                  style="color:#5B4CFF;">“Free-press”</strong> en medios impresos, un equivalente a más de 30 millones de pesos si hubieran sido pagos.</h5>
            </div>
            <div class="col-md-5 px-md-4 to_view to_viewReset py-md-0 py-4">
              <h2 class="mb-2">3 campañas</h2>
              <h5>Creamos 3 campañas de comunicación orientadas a potenciar la protección de derechos de la población migrante venezolana en Colombia y mejorar la cohesión comunitaria y seguridad ciudadana.</h5>
            </div>
          </div>
        </div>
        ...
        <div class="contexto py-lg-5 py-4 mb-5 px-lg-0 px-4 to_viewleft to_viewReset">
          <div class="p-lg-5 p-4">
            ...
            <h5>Conectando Caminos por los Derechos (CCD) es uno de los programas de PACT. Este busca <strong
                  style="color:#5B4CFF;">proteger y prevenir la violación de derechos humanos de la población migrante venezolana en Colombia,</strong> así como mejorar la cohesión comunitaria y la seguridad ciudadana.  Entre las poblaciones priorizadas se encuentran, mujeres, niñas,  niños, jóvenes y adolescentes y población LGBTIQ+. <br>
            <br>
        ...
        <div class="c_gal_detalle">
          <div class="row no-gutters">
            <div class="col-md-6 px-2 to_view to_viewReset mb-3">
              <img src="_/images/grupo3.jpg" alt="">
            </div>
            <div class="col-md-6 px-2 to_view to_viewReset mb-3">
              <img src="_/images/grupo4.jpg" alt="">
            </div>
          </div>
        </div>
            ...
            <div class="c_detalle pb-5 ">
              <article>
                <div class="info_detalle to_view to_viewReset">
                  ...
                  <p>Trabajamos en 3 grandes campañas. Partimos de organizar talleres de co-creación con socios estratégicos para definir productos y mensajes a comunicar. Definimos los contenidos, pilares y audiencia que respondieran a los objetivos de cada una de las campañas.</p>
                </div>
                <img src="_/images/ccdestrate.jpg" alt="" class="to_viewleft to_viewReset">
              </article>
              <article>
                <div class="info_detalle to_view to_viewReset">
                  <h2>ESTRATEGIA DE <br>CONTENIDOS</h2>
                  <p>Realizamos 5 contenidos independientes que estuvieran orientados a cumplir y apoyar el propósito de la campaña, potenciar la cohesión comunitaria y la seguridad ciudadana.</p>
                </div>
                <img src="_/images/ccdconten.jpg" alt="" class="to_viewleft to_viewReset">
              </article>
              <article>
                <div class="info_detalle to_view to_viewReset">
                  <h2>GESTIÓN Y PRODUCCIÓN<br> DE CONTENIDO.</h2>
                  <p>A través del diseño de piezas gráficas y de la producción audiovisual, desarrollamos e implementamos contenidos que respondieron a las 3 campañas y a los 5 contenidos independientes. Con esto, buscamos que la información técnica estuviera en un lenguaje cercano a la audiencia para facilitar su comprensión. Los formatos producciones fueron: infografías, videos motion graphics, afiches, videos, cuñas, material para rrss.</p>
                </div>
                <img src="_/images/ccdproduc.jpg" alt="" class="to_viewleft to_viewReset">
              </article>
              <article>
                <div class="info_detalle to_view to_viewReset">
                  <h2>GESTIÓN EN <br> PRENSA</h2>
                  <p>Realizamos un mapeo de los principales medios de comunicación de los 11 municipios. Gestionamos con diferentes medios como Caracol Radio, RCN Radio, Canal Capital y W radio para publicar diferentes notas de prensa.</p>
                </div>
                <img src="_/images/ccdtelefono.png" alt="" class="to_viewleft to_viewReset">
              </article>
              <article>
                <div class="info_detalle to_view to_viewReset">
                  <h2>PÁGINA WEB.</h2>
                  <p>Creamos contenido audiovisual y tipo blog para publicar en el micrositio de Pact. Publicamos y editamos entradas  en el micrositio que respondieran a los objetivos y al contenido propuesto en cada campaña  y contenido.</p>
                </div>
                <img src="_/images/ccdpagina.jpg" alt="" class="to_viewleft to_viewReset">
              </article>

...
@section('title', 'Imagenes Branding')
...
@section('content')
  ...
  <h4 class="fw-bold py-3 mb-4">Modulo Imagenes Branding</h4>
  <!-- Basic Layout -->
  <div class="row">
    <div class="col-xl">
      <div class="col-xl">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            @if ((int) $edit->id > 0)
              <h5 class="mb-0">Editando una Imagen de Branding</h5> <small class="text-muted float-end">Formulario de edición</small>
            @else
              <h5 class="mb-0">Creando una Imagen de Branding</h5> <small class="text-muted float-end">Formulario de
                creación</small>
            @endif
          </div>
          <div class="card-body">
            <form id="formModel" class="mb-3 row" action="{{ url('/cms/imagenbrand') }}" method="POST" enctype="multipart/form-data">
  ...
  @include('cms/content/imagenbrand/listado')

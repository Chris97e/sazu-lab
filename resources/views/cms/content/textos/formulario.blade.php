...
@section('content')
  ...
  <h4 class="fw-bold py-3 mb-4">Modulo Edicion Textos</h4>
  <!-- Basic Layout -->
  <div class="row">
    <div class="col-xl">
      <div class="col-xl">
        <div class="card">
          ...
          <div class="card-body">
            <form id="formModel" class="mb-3 row" action="{{ url('/cms/textos') }}" method="POST">
              ...
              <div class="mb-3 col-12 col-lg-6">
                ...
                <input type="text" class="form-control required" name="ubicacion" value="{{ $edit->ubicacion }}"
                  placeholder="Ubicacion del texto" />
              </div>
    ...
    @include('cms/content/textos/listado')

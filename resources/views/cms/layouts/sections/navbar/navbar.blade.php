...
@if (isset($navbarFull))
  <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
    <a href="{{ url('/cms') }}" class="app-brand-link gap-2">
...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <div class="navbar-nav align-items-center">
    <div class="nav-item d-flex align-items-center">
      {{-- <i class="bx bx-search fs-4 lh-0"></i> --}}
      &nbsp;
      Sección actual:&nbsp;&nbsp;&nbsp;<span class="fw-bolder"> @yield('title')</span>
    </div>
  </div>
  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
        <i class="bx bx-user-circle display-5"></i>
      ...
      <ul class="dropdown-menu dropdown-menu-end">
          ...
          <div class="dropdown-item">
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                ...
                {{-- <span class="fw-semibold d-block">Ruben Cifuentes</span>
                <small class="text-muted">Super administrador</small> --}}
              </div>
            </div>
          </div>
        </li>
        ...
        <li>
          <a class="dropdown-item" href="{{ url('/cms/inicio') }}">
            <i class="bx bx-home-circle me-2"></i>
            <span class="align-middle">Inicio</span>
          </a>
        </li>
        <li>
          <a class="dropdown-item" href="{{ url('/cms/usuarios') }}">

...
class EstrategiaController extends Controller
{
  public function index(Request $request)
  {
    ...
    $estrategia1 = Textos::where('ubicacion', 'estrategia')->where('identificador', 'estrategia1')->first();
    $estrategia2 = Textos::where('ubicacion', 'estrategia')->where('identificador', 'estrategia2')->first();
    $estrategia3 = Textos::where('ubicacion', 'estrategia')->where('identificador', 'estrategia3')->first();
    $titulotext = Textos::where('ubicacion', 'estrategia')->where('identificador', 'titulotext')->first();
    ...
    $data['estrategia1'] = $estrategia1->descripcion;
    $data['estrategia2'] = $estrategia2->descripcion;
    $data['estrategia3'] = $estrategia3->descripcion;
    $data['titulotext'] = $titulotext->descripcion;
